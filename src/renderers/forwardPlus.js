...
export default class ForwardPlusRenderer extends BaseRenderer {
    constructor(xSlices, ySlices, zSlices) {
        ...
        this._shaderProgram = loadShaderProgram(vsSource, fsSource({
            ...
            uniforms: ['u_viewProjectionMatrix', 'u_colmap', 'u_normap', 'u_lightbuffer', 'u_clusterbuffer', 'u_view_matrix', 'u_screen_width', 'u_screen_height','u_camera_far', 'u_camera_near'],
    ...
    render(camera, scene) {
        ...
        gl.uniform1i(this._shaderProgram.u_screen_width, canvas.width);
        gl.uniform1i(this._shaderProgram.u_screen_height, canvas.height);
